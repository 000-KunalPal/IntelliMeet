...
export const columns: ColumnDef<MeetingGetMany[number]>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Badge variant="outline" className={cn("capitalize text-muted-foreground [&>svg]:size-4", statusColorMap[row.original.status as keyof typeof statusColorMap])}>
    ...
    },
    {
        ...
        header: "Duration",
        cell: ({ row }) => (
            <Badge variant="outline" className="capitalize text-muted-foreground [&>svg]:size-4">
